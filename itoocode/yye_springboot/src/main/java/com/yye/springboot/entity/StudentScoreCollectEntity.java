 ...
 */
@ApiModel(value = "StudentScoreCollectEntity:学生总成绩表")
@Data
@NoArgsConstructor
@Accessors(chain = true)
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
@TableName(value = "tr_student_score_collect")
public class StudentScoreCollectEntity extends BaseEntity implements Serializable {
